 ...
 */
public class Scientific_Calcy extends javax.swing.JFrame {

    /**
     * Creates new form Scientific_Calcy
     */
    public Scientific_Calcy() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Scientific_Calcy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scientific_Calcy().setVisible(true);
            }
        });
    }
